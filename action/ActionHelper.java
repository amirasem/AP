...
//            addActions(Butchery.getInstance(), new CustomNameInteract(new BuyStore(), "BuyStore an item"));
            ...
            //Kitchen
            addActions(Kitchen.getInstance(), new CustomNameInteract(new CheckToolShelfMenu(), "Check Tool Shelf"));
            addActions(Kitchen.getInstance(), new CustomNameInteract(new CheckRecipes(), "Check recpies"), new KitchenCheck());
            //Backpack
...
//            addActions(Ranch.getInstance(), new CustomNameInteract(new CheckShopMenu(), "Check this shop"),
//                    new CustomNameInteract(BuyStore.getInstance(), "BuyStore an item"),
//                    new CustomNameInteract(new BuyAnimalActionMenu(), "BuyStore an animal"));
            //Workshop
            addActions(Workshop.getInstance(), new WorkshopCheck(),
                    new WorkshopBuy(),
                    new CustomNameInteract(new game.action.simple.workshop.Repair(), "RepairGreenhouse a tool"),
