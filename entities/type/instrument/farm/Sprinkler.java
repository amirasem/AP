...
public enum Sprinkler implements Tool {
    ...
    LOG(1,15,false,2 , 2, 2, new Requirements(200, new PairOfEntityTypeValue(Wood.LOGS, 4)),
            ...
            new LivingPropertyChanger(30, LivingPropertyType.ENERGY, LivingPropertyValueType.CURRENT)),
    ...
    OAK(8,5,false,4,9, 8, new Requirements(2000, new PairOfEntityTypeValue(Wood.OAKS, 2)),
            ...
            new LivingPropertyChanger(10, LivingPropertyType.ENERGY, LivingPropertyValueType.CURRENT)),
    ...
    IRON(2,15,false,2,2, 4, new Requirements(200,
            ...
            new LivingPropertyChanger(60, LivingPropertyType.ENERGY, LivingPropertyValueType.CURRENT)),
